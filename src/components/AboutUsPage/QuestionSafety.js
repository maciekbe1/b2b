  ...
  return (
    <div>
      <span className="font-medium text-sm  leading-relaxed mt-4 mb-4 text-gray-700">
        ...
        środowisko przed powstawaniem niebezpiecznych pleśni i grzybów, a
        szczelna warstwa produktu tworzy skuteczną barierę przeciw owadom i
        gryzoniom, które często zasiedlają poddasza lub piwnice.
        <br />
        <br />
        Izolacje natryskowe, w przeciwieństwie do wełny, nie pylą więc są wręcz
        wskazane do stosowania w pomieszczeniach, w których będą przebywać osoby
